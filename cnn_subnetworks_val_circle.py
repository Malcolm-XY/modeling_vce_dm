...
def cnn_subnetworks_evaluation_circle_control_1_(argument='data_driven_pcc_10_15', selection_rate=1, feature_cm='pcc', 
...
if __name__ == '__main__':
    results = cnn_subnetworks_evaluation_circle_control_1_(selection_rate=0.25, feature_cm='pcc', save=True)
