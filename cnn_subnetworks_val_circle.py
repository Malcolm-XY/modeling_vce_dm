...
if __name__ == '__main__':
    ...
    for selection_rate in selection_rate_list:
        cnn_subnetworks_evaluation_circle_control_2(argument='label_driven_pcc_10_15', selection_rate=selection_rate, feature_cm='pcc', save=True)
        ...
        # cnn_subnetworks_eval_circle_rcm_intergrated('basic', 'linear', selection_rate, 'plv', save=True)
        # cnn_subnetworks_eval_circle_rcm_intergrated('basic', 'linear_ratio', selection_rate, 'plv', save=True)
